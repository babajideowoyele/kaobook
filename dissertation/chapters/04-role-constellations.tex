...
Systems thinking has informed organization studies since Katz and Kahn's \needcite{katz-kahn-1978} conceptualization of organizations as open systems. However, as Phillips and Ritala \needcite{phillips-ritala-2019} observe, much organizational research invokes ``system'' language without engaging systems thinking principles.\sidenote{\textbf{Systems vs. ``systems''}---Many studies use systems language descriptively without adopting systems-theoretic reasoning. CAS theory demands more rigorous engagement with mechanisms, not just vocabulary.} The ecosystem concept, despite its systems etymology, has often been applied as metaphor rather than theoretical foundation---what Badinelli et al. \needcite{badinelli-2012} criticized as describing ``interconnectedness of entities'' without adhering to ``systems thinking principles, which often disrupt traditional thinking.''

A \textbf{system} is an entity with interconnected components whose relationships permit identification of a boundary-maintaining process \needcite{laszlo-systems-1998}. Systems become \textbf{complex} when the number and density of relationships makes prediction difficult---not merely complicated (many parts) but genuinely complex (emergent, non-linear). \textbf{Complex adaptive systems} involve components that adapt or learn as they interact, organizing without being controlled by any singular entity \needcite{holland-hidden-order-1995}.
...
Phillips and Ritala's \needcite{phillips-ritala-2019} methodological framework for ecosystem research provides essential scaffolding for our approach. They identify three dimensions that any rigorous CAS-based inquiry must address: \textbf{conceptual}, \textbf{structural}, and \textbf{temporal}. Each dimension poses distinct questions and requires specific methodological attention.
...
\textbf{Emergence} refers to macro-level patterns arising from micro-level interactions that cannot be predicted from, or reduced to, the properties of individual components \needcite{holland-emergence-1997}.\sidenote{\textbf{Emergence}---Macro patterns arising from micro interactions. The ``whole'' exhibits properties not found in any ``part.''} Emergent properties are not designed or intended; they arise spontaneously from the density and nature of interactions.
...
\textbf{Self-organization} is the process by which structure emerges without external control or central coordination \needcite{kauffman-origins-order-1993}.\sidenote{\textbf{Self-organization}---Order without a designer. Structure emerges from local interactions, not central planning.} In self-organizing systems, order arises from local interactions following simple rules, not from top-down design.
...
\begin{tikzpicture}[scale=1.0]
    ...
    \node[draw, circle, fill=Slate!30, minimum size=0.5cm] at (-0.8, 2.2) {};
    \node[draw, circle, fill=Slate!30, minimum size=0.5cm] at (0.3, 2.8) {};
    \node[draw, circle, fill=Slate!30, minimum size=0.5cm] at (0.9, 1.8) {};
    \node[draw, circle, fill=Slate!30, minimum size=0.5cm] at (-0.2, 1.2) {};
    \node[draw, circle, fill=Slate!30, minimum size=0.5cm] at (0.6, 0.6) {};
    \node[draw, circle, fill=Slate!30, minimum size=0.5cm] at (-0.6, 0.4) {};
    \node[draw, circle, fill=Slate!30, minimum size=0.5cm] at (0.1, 3.4) {};
    \node[draw, circle, fill=Slate!30, minimum size=0.5cm] at (-0.4, 2.9) {};
    ...
    \node[draw, circle, fill=Azure!40, minimum size=0.5cm] (a1) at (5.8, 2.8) {};
    \node[draw, circle, fill=Azure!40, minimum size=0.5cm] (a2) at (6.4, 2.2) {};
    \node[draw, circle, fill=Azure!40, minimum size=0.5cm] (a3) at (7.0, 2.9) {};
    \node[draw, circle, fill=Marigold!40, minimum size=0.5cm] (b1) at (8.5, 1.2) {};
    \node[draw, circle, fill=Marigold!40, minimum size=0.5cm] (b2) at (9.1, 0.6) {};
    \node[draw, circle, fill=PandaBamboo!40, minimum size=0.5cm] (c1) at (6.0, 0.4) {};
    \node[draw, circle, fill=PandaBamboo!40, minimum size=0.5cm] (c2) at (6.8, -0.1) {};
    \node[draw, circle, fill=PandaBamboo!40, minimum size=0.5cm] (c3) at (7.6, 0.5) {};
...
\item \textbf{Red Queen dynamics} \needcite{valen-red-queen-1973}: Organizations must continuously adapt just to maintain relative position as the landscape shifts
\item \textbf{Punctuated equilibrium} \needcite{gould-eldredge-punctuated-1977}: Long periods of stability (on peaks) interrupted by rapid change (landscape deformation)
\end{itemize}
...
CAS theory demands attention to multiple levels of analysis and their interactions.\sidenote{\textbf{Multimodal necessity}---Each dimension requires multiple data sources. No single modality captures boundaries, structure, \emph{and} dynamics adequately.} Following Phillips and Ritala's emphasis on multilevel understanding, we distinguish three levels for role constellation analysis:
...
Theoretical frameworks gain value through empirical engagement.\sidenote{\textbf{Proposition logic}---Each proposition derives from CAS mechanisms, specifies observable patterns, and can be assessed with cartographic methods. Chapter~\ref{ch:synthesis} evaluates empirical support.} The CAS reconceptualization generates specific propositions about role constellation dynamics---predictions that multimodal cartography can test. We organize fifteen propositions around the six mechanisms, grouped into conceptual, structural, and temporal domains.
