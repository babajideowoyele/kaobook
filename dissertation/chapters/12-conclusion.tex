...
\begin{tikzpicture}[scale=1.0,
    ...
    \node[rqbox=Azure] (rq1) at (-5.5,1.2) {\textbf{RQ1: Theory}\\[0.1em]\scriptsize How to reconceptualize\\for computation?};
    \node[rqbox=PandaBamboo] (rq2) at (-1.8,1.2) {\textbf{RQ2: Artifacts}\\[0.1em]\scriptsize What tools enable\\multimodal mapping?};
    \node[rqbox=Marigold] (rq3) at (1.8,1.2) {\textbf{RQ3: Patterns}\\[0.1em]\scriptsize Build-up vs.\\breakdown?};
    \node[rqbox=AccentPurple] (rq4) at (5.5,1.2) {\textbf{RQ4: Infrastructure}\\[0.1em]\scriptsize Break down barriers,\\build up resources?};
...
\item \textbf{Knowledge triangle imbalance}: Business vocabulary (43\%) dominates over research (32\%) and education (25\%) across all domains, despite the EIT's founding mission of balanced integration.
