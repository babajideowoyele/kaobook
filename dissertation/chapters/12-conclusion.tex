...
\begin{tikzpicture}[scale=1.0,
    ...
    \node[rqbox=Marigold] (rq3) at (1.8,1.2) {\textbf{RQ3: Patterns}\\[0.1em]\scriptsize What emerges across\\domains?};
    \node[rqbox=AccentPurple] (rq4) at (5.5,1.2) {\textbf{RQ4: Infrastructure}\\[0.1em]\scriptsize How to enable\\accumulation?};
    ...
    \node[ansbox=AccentPurple] (a4) at (5.5,-0.8) {Open source\\Documentation};
...
\begin{mainrq}
What theoretical reconceptualization and methodological artifacts enable multimodal cartography of intermediary role constellations, and what do such maps reveal across intermediation domains?
\end{mainrq}
...
What patterns and dynamics of role constellations emerge when applying multimodal cartography across multiple intermediation domains?
\end{subrq}
