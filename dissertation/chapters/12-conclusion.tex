...
\begin{tikzpicture}[scale=1.0,
    ...
    \node[rqbox=PandaCharcoal, fill=PandaCharcoal!20, minimum width=10cm, minimum height=1.6cm] (main) at (0,4) {
        \textbf{Main RQ: What role constellations characterize interstitial actors,}\\
        \textbf{and how does multimodal cartography reveal their emergence?}
    };
    ...
    \node[rqbox=Marigold] (rq3) at (1.8,1.2) {\textbf{RQ3: Empirics}\\[0.1em]\scriptsize Build-up vs.\\breakdown?};
    \node[rqbox=AccentPurple] (rq4) at (5.5,1.2) {\textbf{RQ4: Implications}\\[0.1em]\scriptsize Break down barriers,\\build up resources?};
    ...
    \node[ansbox=Marigold] (a3) at (1.8,-0.8) {Interstitial pluralism\\Build-up bias\\5 sociotypes};
    \node[ansbox=AccentPurple] (a4) at (5.5,-0.8) {Open infrastructure\\Breaking barriers\\Building resources};
...
\end{tikzpicture}
\captionof{figure}{Research question structure and answers. The main research question decomposes into four sub-questions, each addressed by specific dissertation chapters. RQ1 (theory) developed CAS reconceptualization with 15 propositions; RQ2 (artifacts) built \RoleBox{} with six modality pipelines; RQ3 (patterns) revealed interstitial pluralism, build-up bias, and five recurring sociotypes across the EIT ecosystem; RQ4 (infrastructure) delivered open infrastructure that breaks down barriers while building up shared resources.}
