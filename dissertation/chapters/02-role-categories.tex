...
\noindent These six problems directly motivate our first sub-research question: \textit{What conceptual framework enables theory-guided but empirically open analysis of role constellations?} The literature provides conceptual vocabulary---role constellations, intermediary functions, ecologies---but lacks operationalization at scale. The cartographic reframings outlined above constitute this dissertation's theoretical response.
\end{summarybox}
