...
This dissertation occupies an intersection Information Systems is uniquely placed to theorise: where Big Data meets domain theory, and where designed artifacts produce knowledge neither tradition achieves alone \parencite{maass2018data}. It studies the role constellations of intermediary organizations in sustainability transitions through workflow-centric Design Science Research and a sociomaterial ontology \parencite{Orlikowski2007}---the digital platforms we analyse are not neutral windows but material co-constitutors of what organizational roles become observable.

Three findings result: a \emph{connector gap} between claimed and enacted bridging roles; a \emph{Knowledge Triangle imbalance} (business 49\%, research 37\%, education 14\%) challenging the EIT mandate; and \emph{five website sociotypes} invisible to single-modality analysis. This chapter establishes the problem, frames the Design Science approach, introduces \RoleBox{} as the demonstrative platform, and maps the journey ahead.
\end{chapteroverview}
...
This dissertation develops and demonstrates \RoleBox as a proof-of-concept platform for multimodal cartography, instantiating six data modalities in an integrated analytical environment. But before detailing the artifacts, we must establish the methodological framework that guides their construction: Design Science Research.
