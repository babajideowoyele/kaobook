...
The methodology directly serves our three research questions: \textbf{RQ1} (What role constellations characterize EIT KICs?) requires systematic data collection and analysis across modalities. \textbf{RQ2} (How do claimed roles compare with enacted roles?) demands triangulation infrastructure comparing self-presentation against external evidence. \textbf{RQ3} (What design principles enable multimodal cartography?) emerges from the DSR process itself---the methodological knowledge generated through building and refining the toolkit.
\end{chapteroverview}
