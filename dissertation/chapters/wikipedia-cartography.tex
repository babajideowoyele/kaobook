...
\begin{replicationbox}[Wikipedia Cartography Pipeline]
\faLaptopCode\ \textbf{Data collection}: Wikipedia API + Wikidata SPARQL endpoint
\begin{itemize}[leftmargin=*, itemsep=0.1em]
    \item 243 entities: 111 NetZeroCities cities + 132 EIT KIC partner organizations
    \item 218 articles retrieved (90\% coverage); cities 100\%, organizations 81\%
\end{itemize}
\faLaptopCode\ \textbf{Processing}: spaCy NER, BERTopic, kg-gen (Llama 3.2), Powell Triangle scoring
\begin{itemize}[leftmargin=*, itemsep=0.1em]
    \item 172,774 entity mentions; 1,311 KG entities; 1,330 relations; 734 predicates
\end{itemize}
\faLaptopCode\ \textbf{Code}: \texttt{rolebox-wikipedia} module (see Appendix~\ref{app:wikipedia})
\end{replicationbox}
