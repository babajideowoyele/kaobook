...
\begin{itemize}[leftmargin=*, itemsep=0.1em]
    \item Curation: Wikipedia API + Wikidata SPARQL $\rightarrow$ 243 entities, 218 articles (90\% coverage)
    \item Annotation: spaCy NER, BERTopic, kg-gen (Llama~3.2), Powell Triangle scoring
    \item Output: 172,774 mentions; 1,311 KG entities; 734 predicates
\end{itemize}
