...
Aggregating across KICs reveals the ecosystem's cumulative scale \cite{eit2024impact}:
...
The \textbf{EIT Regional Innovation Scheme (RIS)}, introduced in 2014, dedicates 10--15\% of EIT funding to activities in ``modest and moderate innovator'' countries---primarily Central, Eastern, and Southern Europe \cite{eit2024ris}. Ten-year results (2014--2024):
...
The \textbf{ITRE Committee Draft Report (2024)}\sidenote{\textbf{EIT Response}---Financial sustainability proves the model; EIC merger would be ill-advised.} characterized EIT as ``non-core, redundant and underperforming,'' recommending radical reform including ``significant reductions (or elimination) of FP funding.''
