...
This intermezzo introduces the empirical site for this dissertation: the European Institute of Innovation and Technology (EIT) and its eight Knowledge and Innovation Communities (KICs). We trace the EIT's origins in the ``European paradox'' diagnosis, examine its institutional architecture and €6 billion investment, profile each KIC's distinctive intermediary character, and document the ecosystem's scale---2,420+ partners, 9,900+ startups, 880,000+ learners. We conclude by explaining why this ecosystem provides an ideal site for developing and demonstrating multimodal cartographic methods for mapping intermediary role constellations. This intermezzo establishes the terrain for our third sub-research question: \textit{What role patterns emerge when multimodal cartography is applied to the EIT ecosystem?}
\end{chapteroverview}
...
The EIT was born from frustration with a persistent pattern: Europe excelled at research but struggled to convert discoveries into innovations, companies, and jobs \cite{etzkowitz2000dynamics}.\sidenote{\textbf{The European Paradox}---Europe produces world-class science but lags in commercialization.}

The 2006 Aho Report crystallized the case for institutional innovation.\sidenote{\small\href{https://ec.europa.eu/invest-in-research/pdf/download_en/aho_report.pdf}{Aho et al.\ (2006). \textit{Creating an Innovative Europe}. European Commission.}} Europe had world-class universities and research institutes. It invested substantially in R\&D. Yet somehow the innovations---and the companies built on them---kept emerging elsewhere. Silicon Valley dominated digital platforms. American and Asian firms led in semiconductors, batteries, and biotechnology. The continent that invented the World Wide Web watched others capture its value.
...
The prescription was integration: create organizations \textit{designed} to bridge these worlds \sidecite{carayannis2009mode,leydesdorff2006knowledge}. Not universities that dabble in business, or companies that sponsor research, but purpose-built integrators whose core mission is connection itself.

\textbf{Regulation (EC) No 294/2008} established the European Institute of Innovation and Technology, headquartered in Budapest.\sidenote{\small\href{https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32008R0294}{Regulation (EC) No 294/2008. \textit{Official Journal of the EU} L~97/1.}} But crucially, the EIT was not conceived as a campus-based institution---no ``European MIT.'' Instead, it would function as a \textbf{meta-orchestrator}, creating and coordinating autonomous Knowledge and Innovation Communities that would do the actual integration work across Europe.
...
The EIT operates as an EU body with its own legal personality, governed by a 15-member Governing Board drawn from academia, business, and innovation sectors. The Board sets strategic direction, selects and evaluates KICs, and can discontinue underperforming partnerships. An EIT Director (Martin Kern since 2014) manages operations from Budapest with a small headquarters staff.\sidenote{\textbf{Key Legislative Milestones}---2008: Founding regulation. 2013: Integration into Horizon 2020; RIS introduced. 2021: Recast regulation under Horizon Europe.}
...
The KICs divide into three ``waves''\sidenote{\textbf{Note on Scope}---EIT Culture \& Creativity (2022) excluded due to limited history.} reflecting their founding periods and maturity stages:
...
% KIC icon removed for cleaner layout

Climate-KIC has undergone the most dramatic strategic evolution among KICs, pivoting from conventional accelerator models toward what it calls ``\textbf{Systems Innovation as a Service}'' \sidenote{\small\href{https://www.climate-kic.org/}{EIT Climate-KIC (2023). \textit{Strategic Plan: Systems Innovation as a Service}.}}. Under CEO Kirsten Dunlop (since 2017), it developed the \textbf{Deep Demonstrations} methodology---portfolio-based, place-based transformation programs that work with cities and regions to catalyze systemic change rather than supporting individual innovations in isolation.
...
Climate-KIC now serves as lead orchestrator for the \textbf{EU Cities Mission} (100 Climate Neutral Cities by 2030) through the NetZeroCities platform, supporting 112 cities in developing Climate City Contracts.\sidenote{\textbf{Climate-KIC Metrics}---Partners: 400+. Startups: 2,300+. Investment: €1.1B. Products: 790. EIT funding: €720M.}
...
The results are striking.\sidenote{\textbf{InnoEnergy Metrics}---Partners: 1,400+. Portfolio: 540+ companies. Investment: €34B+. Jobs: 47,000+. Unicorns: 5. Graduates: 2,000+.} From 9,000+ evaluated ventures, InnoEnergy built a portfolio of 540+ companies that have collectively raised over \textbf{€34 billion} in investment. The portfolio includes \textbf{five unicorns}:
...
The KIC operates through seven Co-Location Centers (CLCs) plus the InnoStars cluster serving Hungary, Italy, Poland, and Portugal. International hubs in the US and Israel extend global reach.\sidenote{\textbf{EIT Health Metrics}---Partners: $\sim$150. Ventures: 3,370. Investment: €2.4B. Learners: 70,000+. Lives impacted: 780,000+.}
...
The KIC manages the \textbf{European Raw Materials Alliance (ERMA)}: 750+ members, 40+ projects, €25B+ investment potential. This positions RawMaterials as a key implementation arm for EU strategic autonomy in materials.\sidenote{\textbf{RawMaterials Metrics}---Partners: 300+. Funding: €600M+ direct, €5B leveraged. Projects/startups: 800+. Master's: 6. Trainees: 76,000+.}
...
The KIC's three-tier entrepreneurship pathway---Seedbed Incubator, Accelerator Network, and RisingFoodStars association---has supported over 500 startups that have collectively attracted €1.1B+ in investment.\sidenote{\textbf{EIT Food Metrics}---Partners: 200+. Startups: 1,438+. Investment: €1.1B+. Graduates: 1,132. Non-degree learners: 52,944.}
...
The \textbf{Skills.Move platform} offers 230+ courses in AI, robotics, additive manufacturing, and sustainable production---reflecting manufacturing's acute skills gaps.\sidenote{\textbf{Manufacturing Targets (2030)}---Trained: 50,000. Startups: 1,000. Products: 360. Investment: €325M. Sustainable adoption: 60\%+.}
...
The KIC has conducted \textbf{185+ pilots} in European cities since 2020 and ranks as the \textbf{\#1 investor in European mobility startups} for 2023--2024 according to Via ID/Dealroom analysis.\sidenote{\textbf{Urban Mobility Metrics}---Partners: 270+. Portfolio: 135 startups (€1B value). Women-led: 43\%. City pilots: 185+.}
...
Aggregating across KICs reveals the ecosystem's cumulative scale:\sidenote{\small\href{https://www.eit.europa.eu/about-us/eit-glance}{EIT (2024). \textit{Community Impact Report}. Budapest.}}
...
\begin{tikzpicture}[scale=1.1]
    ...
    \foreach \x/\year in {0/2010, 2.8/2013, 5.6/2016, 8.4/2019, 11.2/2022, 14/2025} {
        ...
        \node[font=\scriptsize, text=Slate] at (\x, -0.5) {\year};
    }

    % KIC launches
    \node[draw, circle, fill=PandaBamboo!40, minimum size=0.5cm, font=\tiny] at (0, 0.8) {};
    \node[draw, circle, fill=Marigold!40, minimum size=0.5cm, font=\tiny] at (0, 1.4) {};
    \node[draw, circle, fill=Azure!40, minimum size=0.5cm, font=\tiny] at (0, 2.0) {};
    \node[font=\scriptsize, text=Slate, align=left] at (1.4, 1.4) {Climate, InnoEnergy,\\Digital launch};

    \node[draw, circle, fill=PandaRose!40, minimum size=0.5cm, font=\tiny] at (5.6, 0.8) {};
    \node[draw, circle, fill=Slate!40, minimum size=0.5cm, font=\tiny] at (5.6, 1.4) {};
    \node[font=\scriptsize, text=Slate, align=left] at (6.9, 1.1) {Health, Raw-\\Materials};

    \node[draw, circle, fill=PandaBamboo!20, minimum size=0.5cm, font=\tiny] at (7.5, 0.8) {};
    \node[font=\scriptsize, text=Slate] at (7.5, 1.4) {Food};

    \node[draw, circle, fill=Slate!20, minimum size=0.5cm, font=\tiny] at (9.8, 0.8) {};
    \node[draw, circle, fill=Azure!20, minimum size=0.5cm, font=\tiny] at (9.8, 1.4) {};
    \node[font=\scriptsize, text=Slate, align=left] at (11.1, 1.1) {Mfg, Urban\\Mobility};

    % Financial sustainability
    \draw[AccentPurple, thick, dashed] (13.5, -0.3) -- (13.5, 2.5);
    \node[font=\scriptsize, text=AccentPurple, align=center] at (13.5, 2.9) {First wave\\achieves FS};

    % Partner growth curve (stylized)
    \draw[thick, CoverGold, domain=0:14, samples=50] plot (\x, {0.3 + 1.8*(1-exp(-\x/5))});
    \node[font=\scriptsize, text=CoverGold] at (12, 2.7) {2,420+ partners};
\end{tikzpicture}
...
Investment attraction varies dramatically across KICs, reflecting different strategic models.\sidenote{\textbf{InnoEnergy Dominance}---80\%+ of investment due to equity model and capital-intensive focus.}
...
The \textbf{EIT Regional Innovation Scheme (RIS)}, introduced in 2014, dedicates 10--15\% of EIT funding to activities in ``modest and moderate innovator'' countries---primarily Central, Eastern, and Southern Europe.\sidenote{\small\href{https://www.eit.europa.eu/news-events/news/check-out-our-2024-eit-regional-innovation-scheme-activity-report}{EIT (2024). \textit{RIS: 10 Years of Impact (2014--2024)}.}} Ten-year results (2014--2024):
...
\textbf{Seven-Year Partnership Agreements}\sidenote{\textbf{Partner Types}---Universities dominate numerically; corporations provide most co-funding.} define KIC-EIT relationships, setting performance targets, funding trajectories, and evaluation milestones. \textbf{Specific Grant Agreements} cover annual or multi-annual implementation.
...
The EIT operates within \textbf{Pillar III ``Innovative Europe''} of Horizon Europe, alongside the European Innovation Council (EIC) and European Innovation Ecosystems program.\sidenote{\textbf{Green Deal Alignment}---5 of 8 KICs support Green Deal objectives.} KICs are formally recognized as ``Institutionalised European Partnerships''---long-term public-private partnerships delivering EU-wide impact.
...
As the EU prepares Framework Programme 10 (post-2027), EIT faces its most significant policy challenge. In January 2025, the \textbf{Danish government position paper} called for EIT discontinuation:\sidenote{\small\href{https://www.horizontevropa.cz/files_public/elfinder/5463/Danish_Position_Paper_on_the_Future_EU_Framework_Programme_for_research_and_in_pt5TA9H.pdf}{Government of Denmark (2025). \textit{Position Paper on FP10}.}}
...
The \textbf{ITRE Committee Draft Report (2024)}\sidenote{\small\href{https://www.europarl.europa.eu/doceo/document/ITRE-PR-765325_EN.pdf}{ITRE PE765.325 (Ehler, rapporteur).} \textbf{EIT Response}---Financial sustainability proves the model; EIC merger would be ill-advised.} characterized EIT as ``non-core, redundant and underperforming,'' recommending radical reform including ``significant reductions (or elimination) of FP funding.''
...
Despite €6 billion cumulative investment, \textbf{academic research on EIT is surprisingly sparse} \cite{pontikakis2022role,kivimaa2019innovation}.\sidenote{\textbf{Theoretical Lenses}---Triple Helix, intermediary theory, ecosystems.} Most systematic analyses come from grey literature---evaluation reports, Court of Auditors assessments---rather than peer-reviewed journals.

Key contributions include Maassen \& Stensaker's critique of the ``instrumental vision'' underlying knowledge triangle policy \cite{maassen2011knowledge}, and Leceta \& Ranga's application of ecosystem frameworks to EIT Digital \cite{leceta2020eit}. León et al. document EIT's impact on educational innovation \cite{leon2018eit}, while later work traces EIT Digital's evolution toward international entrepreneurial ecosystems \cite{leceta2021eitdigital,balassone2024eitdigital}. De Bernardi \& Azucar provide a comprehensive analysis of EIT Food's ecosystem model \cite{debernardi2020eitfood}. Climate-KIC has received attention both from sustainability transitions researchers and from education scholars examining its transformative pedagogy approaches \cite{klapper2024pedagogy}.\sidenote{\textbf{Scopus search}---\texttt{TITLE-ABS-KEY("European Institute of Innovation and Technology" OR "EIT KIC" OR "Knowledge and Innovation Community")} yields $\sim$130 peer-reviewed articles as of 2025.} Recent work on systemic intermediation positions EIT-related research within broader debates on transformative innovation policy \cite{brodnik2024intermediation}.
...
The EIT ecosystem provides an ideal empirical site for developing and demonstrating multimodal cartography of intermediary role constellations.\sidenote{\textbf{Empirical Advantages}---Designed intermediaries, transition relevance, rich traces, 15-year history.} Several features make it particularly suitable:

\textbf{Designed intermediaries.} KICs are explicitly created as intermediaries---their core purpose is connecting, translating, and facilitating between knowledge triangle actors \cite{howells2006intermediation,vanLente2003roles}. If we want to understand intermediary role constellations, studying organizations designed for intermediation provides an exceptionally clear case.

\textbf{Intermediation domains.} Eight KICs span distinct thematic domains---health, digital, climate, energy, raw materials, food, urban mobility, and manufacturing---each representing a different intermediation context \cite{jacobides2018ecosystems}. Five directly address sustainability transitions (climate, energy, raw materials/circularity, food, urban mobility) \sidecite{geels2017sustainability,markard2020challenges}, while others (health, digital, manufacturing) provide comparative leverage for understanding domain-specific role dynamics.
