...
\intermezzo{Websites: Mapping Claimed Identity}

\begin{center}
\begin{tikzpicture}
    \fill[Azure] (-2,0) rectangle (-1.7,0.08);
    \fill[Azure!70] (-1.5,0) rectangle (-1.2,0.08);
    \fill[Azure!50] (-1,0) rectangle (-0.7,0.08);
    \fill[Azure!30] (-0.5,0) rectangle (-0.2,0.08);
    \fill[Azure!15] (0,0) rectangle (0.3,0.08);
\end{tikzpicture}
\end{center}
...
Websites are shop windows. Organizations curate them to project who they \emph{want} to be seen as---their \textbf{claimed identity}. This chapter establishes why website data matters for role constellation cartography, how we collect and analyze it, and what the first modality of \RoleBox reveals about the EIT ecosystem. We discover that what actors \emph{say} they are is only the beginning of understanding what they \emph{do}.
\end{chapteroverview}
